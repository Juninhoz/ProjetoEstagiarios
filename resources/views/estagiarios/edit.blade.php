        ...
        <div class="container-fluid">
            <div class="panel">
                <div class="panel-body">
                    <form action="{{ action('EstagiariosController@update', $estagiario->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                                ...
                                <div class="form-group col-md-4 has-error">
                                    @else
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Nome" name="nome" value="{{ $estagiario->nome }}">
                                            @if($errors->has('nome'))
                                            ...
                                            <div class="form-group col-md-4 has-error">
                                                @else
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="email" class="form-control" placeholder="Email" name="email" value="{{ $estagiario->email }}">
                                                        @if($errors->has('email'))
                                                                        ...
                                                                        <div class="form-group col-md-4 has-error">
                                                                            @else
                                                                                <div class="form-group col-md-4">
                                                                                    ...
                                                                                    <input type="text" class="form-control phone" placeholder="Telefone" name="telefone" value="{{ $estagiario->telefone }}">
                                                                                    @if($errors->has('telefone'))
                                                                                    ...
                                                                                    <div class="form-group col-md-4 has-error">
                                                                                        @else
                                                                                            <div class="form-group col-md-4">
                                                                                                ...
                                                                                                <input type="date" class="form-control" placeholder="Data contrato" name="data_contrato" value="{{ $estagiario->data_contrato }}">
                                                                                                @if($errors->has('data_contrato'))
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="form-group col-md-2 col-md-offset-5" style="margin-top: 10px">
                                                                                            <button class="btn btn-primary" type="submit">
                                                                                                <i class="glyphicon glyphicon-floppy-save"></i> Atualizar
                                                                                            </button>
