...
class Estagiario extends Model {
    ...
    protected $fillable = [
        'nome_estagiario','email_estagiario','telefone',
        'data_contrato','horario','pri_renovacao','seg_renovacao',
        'ter_renovacao','fim_contrato','id_horario','id_status',
    ];
    ...
    public function calculaRenovacoesEstagiario(Estagiario $estage)
    {         
    ...
    public function converteExibicaoDeDatas($estage)
    {
        $i = 0;
    ...
    public function verificaRenovaçõesEstagiario($estagiario)
    {
        $message = Array();
        $qtdAvisos;
    ...
    public function calculaDiferençaEntreDatas($dataCalculo,$nrRenovacao)
    {
